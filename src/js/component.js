class Navbar extends HTMLElement {
    connectedCallback() {
        ...
        <nav id="navbar"
            ...
            <h1
                 id="navBarHeader"class="font-bold relative z-20 lg:text-[2vw] text-black font-hello hover:text-gray-300 transition-colors duration-300 textColor">
                <a href="../../index.html">EvoXcel</a>
            </h1>
            <ul
                class="hidden lg:flex w-[45%] relative z-50 items-center justify-between text-[1.4vw] font-[400] text-black textColor">
...
window.addEventListener('scroll', function () {
    var navbar = document.getElementById('navbar'); navBarHeader
    var nabarHeader = document.getElementById('navBarHeader');
    if (window.scrollY > 50) { // Adjust this value as needed
        navbar.classList.add('navbar-scrolled');
        nabarHeader.classList.remove('textColor');
    } else {
        navbar.classList.remove('navbar-scrolled');
        nabarHeader.classList.add('textColor');
    }
});